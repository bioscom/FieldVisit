<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/BI500.master" AutoEventWireup="true" CodeFile="OnBehalfEdt.aspx.cs" Inherits="App_BI500_OnBehalfEdt" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="UserControl/BrightIdeasOnBehalfEdt.ascx" TagName="BrightIdeaOnBehalfEdt" TagPrefix="uc2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <uc2:BrightIdeaOnBehalfEdt ID="BrightIdeasOnBehalfEdt1" runat="server" />
        </ContentTemplate>
    </asp:UpdatePanel>
