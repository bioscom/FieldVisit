...
<table class="tMainBorder" style="width: 800px; border-collapse: separate">
    <%--<asp:DropDownList ID="ddlChampion" runat="server" Width="250px">
                    <asp:ListItem Value="-1">Select Project Champion</asp:ListItem>
                </asp:DropDownList>--%>
    <tr>
...
<table class="tMainBorder" style="width: 800px; margin-top: 0.5em; border-collapse: separate">
    ...
    <tr>
        <td style="background-color: gainsboro">
            <asp:Label ID="Label10" runat="server" Text="Lean Team Support Focal Point:" Font-Bold="True"></asp:Label>
            <%--<asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="drpFocalPoint" ErrorMessage="Lean Focal Point is Required" Operator="NotEqual" Type="Integer" ValueToCompare="-1">*</asp:CompareValidator>--%>
        </td>
        <td style="vertical-align: middle">
            <%--<asp:DropDownList ID="drpFocalPoint" runat="server" Width="250px">
                <asp:ListItem Value="-1">Select Lean Focal Point</asp:ListItem>
            </asp:DropDownList>--%>
