<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BrightIdeaOnBehalf.ascx.cs" Inherits="App_BI500_UserControl_BrightIdeaOnBehalf" %>
...
<table class="tMainBorder" style="width: 800px; margin-top: 0.5em">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:TextBox ID="txtFullname" runat="server" Width="400px"></asp:TextBox>
