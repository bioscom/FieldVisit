...
public partial class App_BI500_UserControl_BrightIdeasForm : aspnetUserControl
{
    ...
    public void Page_Init()
    {
        ...
        if (o.objGetTeamByUserId(oSessnx.getOnlineUser.m_iUserId).m_iTeamId == 0)
        {
            Response.Redirect("~/App/BI500/YourTeam.aspx");
        }
        else
        {
        ...
        try
        {
            if (string.IsNullOrEmpty(HFRequestId.Value) || (long.Parse(HFRequestId.Value) == 0))
            {
                ...
                else
                {
                    ...
                    BIUserTeam o = new BIUserTeam();
                    BIUserTeam oUT = o.objGetTeamByUserId(oSessnx.getOnlineUser.m_iUserId);
