<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oApprovedRequest.ascx.cs" Inherits="App_BI500_UserControl_Cost_oApprovedRequest" %>
...
<asp:GridView ID="grdGridView" runat="server" AllowPaging="True"
    ...
    <Columns>
       ...
       <%-- <asp:TemplateField HeaderText="Project Phase">
            <ItemTemplate>
                <asp:LinkButton ID="PhaseLinkButton" runat="server" OnClick="lnkPhase_Click" ValidationGroup="Apx"
                    CommandArgument="<%# Container.DisplayIndex %>" IDREQUEST='<%# DataBinder.Eval(Container.DataItem, "IDREQUEST") %>'
                    Font-Bold="True" Text='<%# DataBinder.Eval(Container.DataItem, "PHASE") %>'></asp:LinkButton>
            </ItemTemplate>
...
<asp:Panel ID="pnlModalPanel" runat="server" Style="display: none;" CssClass="modalPopup" Width="570px">
    <asp:Panel ID="pnlDragPanel" runat="server" Style="cursor: move; background-color: #DDDDDD; border: solid 1px Gray; color: Black">
        <div>
            ...
            <div style="float: right">
                <asp:Button ID="closeButton" runat="server" Text="Close" ValidationGroup="kkk" Width="100px" />
            </div>
        </div>
    </asp:Panel>
    <br />
