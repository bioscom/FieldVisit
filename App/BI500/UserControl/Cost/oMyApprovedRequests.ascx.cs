...
public partial class App_BI500_UserControl_Cost_oApprovedRequests : aspnetUserControl
{
    ...
    {
        grdGridView.DataSource = oBI500RequestHelper.dtGetMyApprovedImprovementIdeas(oSessnx.getOnlineUser.m_iUserId);
    ...
    {
        grdGridView.DataSource = oBI500RequestHelper.dtGetMyApprovedImprovementIdeas(oAppUser.m_iUserId);
        grdGridView.DataBind();
