<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MonthlyReport.ascx.cs" Inherits="App_BI500_UserControl_MonthlyReport" %>

<%@ Register Src="GraphicalReports.ascx" TagName="GraphicalReports" TagPrefix="uc2" %>

<table class="tMainBorder" style="width: 98%">
    <tr>
        <td class="cHeadTile" colspan="2">Bright Ideas Monthly Report
        </td>
    </tr>
    <tr>
        <td colspan="2">
    ...
    <tr>
        <td colspan="2">
            <b>Monthly Report:</b>
            <asp:Repeater ID="MonthlyRepeater" runat="server" OnItemCommand="MonthlyRepeater_ItemCommand">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkMonth" runat="server" IMONTH='<%# DataBinder.Eval(Container.DataItem, "ID") %>'
                        MMONTH='<%# DataBinder.Eval(Container.DataItem, "MMONTH") %>'
                        Text='<%# DataBinder.Eval(Container.DataItem, "MMONTH") %>' />&nbsp;                                        
                </ItemTemplate>
            </asp:Repeater>
        </td>
    </tr>
