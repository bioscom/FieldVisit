...
public partial class App_BI500_UserControl_YearlyReport : System.Web.UI.UserControl
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                lstBI500Request = oRpt.lstGetRequestsByDepartmentYear(int.Parse(ddlYear.SelectedValue), int.Parse(ddlDepartment.SelectedValue));
            }
            if (int.Parse(ddlTeam.SelectedValue) != -1)
            {
                lstBI500Request = oRpt.lstGetRequestsByTeamYear(int.Parse(ddlYear.SelectedValue), int.Parse(ddlTeam.SelectedValue));
            }
            else
            {
                lstBI500Request = oRpt.lstGetRequestsByBusinessUnitYear(int.Parse(ddlYear.SelectedValue), int.Parse(ddlFunction.SelectedValue));
            }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (int.Parse(ddlDepartment.SelectedValue) != -1)
            {
                dt = oRpt.dtGetRequestsByDepartmentYear(iYear, int.Parse(ddlDepartment.SelectedValue));
                //Graph Plotting
                GraphicalReports1.GraphicalReportByYearDepartment(iYear, int.Parse(ddlDepartment.SelectedValue), int.Parse(ddlFunction.SelectedValue));
            }
            else if ((int.Parse(ddlDepartment.SelectedValue) != -1) && (int.Parse(ddlTeam.SelectedValue) != -1))
            {
                dt = oRpt.dtGetRequestsByTeamYear(iYear, int.Parse(ddlTeam.SelectedValue));
            }
            else if ((int.Parse(ddlFunction.SelectedValue) != -1) && (int.Parse(ddlDepartment.SelectedValue) == -1) && (int.Parse(ddlTeam.SelectedValue) == -1))
            {
                dt = oRpt.dtGetRequestsByBusinessUnitYear(iYear, int.Parse(ddlFunction.SelectedValue));
                //Graph Plotting
                GraphicalReports1.GraphicalReportByYearFunction(iYear, int.Parse(ddlFunction.SelectedValue));
            }
            ...
            lblMessage.Text = ddlFunction.SelectedItem.Text + " number of Bright Ideas in " + iYear + " = " + dt.Rows.Count + " of (" + iTotalYearBI.ToString() + " Total number of BI)";
