<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DetailView2.ascx.cs" Inherits="App_BONGACCP_UserControl_DetailView2" %>
            ...
            <td colspan="4" style="border: 1px solid silver">
                <fieldset style="width: 99%; margin-top: 0.2em">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><strong>Decision Comment:</strong></td>
                            <td>
                                <asp:Label ID="lblDecisionComments" runat="server"></asp:Label>
...
<%--<table style="width: 800px" class="tMainBorder">
    <tr class="cHeadTile">
        <td colspan="4"><h3>Commitment Control</h3></td>
    </tr>
    <tr>
        <td style="width: 200px"><strong>Cost Object:</strong></td>
        <td colspan="3">
            <asp:Label ID="lblCostObject" runat="server"></asp:Label>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <strong>Qty/Duration Checked By?:</strong></td>
        <td colspan="3">
            <asp:Label ID="lblCheckedBy" runat="server"></asp:Label>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <strong>New or Represented:</strong></td>
        <td colspan="3">
            <asp:Label ID="lblNewRepresented" runat="server"></asp:Label>
        </td>
    </tr>
    <tr>
        <td><strong>Activity Period:</strong></td>
        <td colspan="3">
            <asp:Label ID="lblActivityPeriod" runat="server"></asp:Label>
        </td>
    </tr>
    <tr>
        <td><strong>Contract/Procurement Vehicle:</strong></td>
        <td colspan="3">
            <asp:Label ID="lblVehicle" runat="server"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
            <strong>Contract No. &amp; Vendor:</strong></td>
        <td colspan="3">
            <asp:Label ID="lblContractNo" runat="server"></asp:Label>
        </td>
    </tr>
    ...
    <tr>
        <td><strong>Regrets/Implication of non approval:</strong></td>
        <td colspan="3">
            <asp:Label ID="lblThreat" runat="server"></asp:Label>
        </td>
    </tr>
    ...
    <tr>
        <td class="cHeadTile" colspan="4">Cost Breakdown<asp:HiddenField ID="CommitmentHF" runat="server" />
        </td>
    </tr>
    <tr>
        <td colspan="4">
    ...
    <tr class="cHeadTile">
        <td colspan="4"><h3>Approval Decision</h3></td>
    </tr>
    <tr>
        <td><strong>Decision:</strong></td>
        <td colspan="3">
