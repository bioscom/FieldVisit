<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FinanceDirectors.ascx.cs" Inherits="App_CommitmentControl_UserControl_FinanceDirector" %>
...
<div style="width: 99%" class="demo-container size-narrow">
    <table style="color: black">
        <tr>
            <td>
                <asp:Label ID="lblLocation2" runat="server" Text="Search Finance Director:"></asp:Label>
            </td>
            <td>
                ...
                <telerik:RadComboBox RenderMode="Lightweight" ID="ddlAdmin" runat="server" Height="200" Width="430px" Font-Size="10pt"
                    DropDownWidth="500" EmptyMessage="Select Administrator..." HighlightTemplatedItems="true"
            ...
            <td>
                <telerik:RadComboBox RenderMode="Lightweight" ID="ddlOU" Font-Size="9pt" runat="server" Width="150px" EmptyMessage="Choose OU" Skin="Office2010Silver">
                </telerik:RadComboBox>
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator5" ControlToValidate="ddlOU"
                                Display="Dynamic" ErrorMessage="Please select Organisation Unit" CssClass="validator">*</asp:RequiredFieldValidator>
            </td>
            <td>
                <asp:Button ID="btnSave" runat="server" Text="Add Finance Director" OnClick="btnSave_Click" Width="150px" />
            </td>
        </tr>
    </table>
    ...
    <telerik:RadGrid ID="grdView" runat="server" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" AllowPaging="True" AllowSorting="true"
        ...
        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="USERID" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="FULLNAME" HeaderButtonType="TextButton" HeaderText="Finance Director" SortExpression="FULLNAME"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="OU" HeaderButtonType="TextButton" HeaderText="Organisation Unit" SortExpression="OU"></telerik:GridBoundColumn>
