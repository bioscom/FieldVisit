<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oCommitmentsApprovedTele.ascx.cs" Inherits="App_BONGACCP_UserControl_oCommitmentsApprovedTele" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function ShowApprovedDetailsForm(id, rowIndex) {
            var grid = $find("<%= grdViewApproved.ClientID %>");

            var rowControl = grid.get_masterTableView().get_dataItems()[rowIndex].get_element();
            grid.get_masterTableView().selectItem(rowControl, true);

            var wndw = window.radopen("ViewDetails2.aspx?lCommitmentId=" + id, "UserListDialog");
...
<div id="demo" class="demo-container no-bg" style="width: 99%">
    ...
    <telerik:RadGrid RenderMode="Lightweight" ID="grdViewApproved" AllowSorting="true" runat="server" PageSize="15" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" AllowAutomaticDeletes="true" AllowPaging="True"
        OnItemUpdated="grdViewApproved_ItemUpdated" OnItemCreated="grdViewApproved_ItemCreated" ShowFooter="True" 
        OnItemCommand="grdViewApproved_ItemCommand" OnItemDataBound="grdViewApproved_ItemDataBound" OnNeedDataSource="grdViewApproved_NeedDataSource" Width="100%">
