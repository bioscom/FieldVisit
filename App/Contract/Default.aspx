<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/14DayContract.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="App_Contract_Default" %>
                                ...
                                <asp:TemplateField HeaderText="...">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="Update2LinkButton" runat="server" CommandArgument="<%# Container.DisplayIndex %>"
                                            CommandName="Update2" ID_DISTRICT='<%# DataBinder.Eval(Container.DataItem, "ID_DISTRICT") %>'>Update Contract</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
