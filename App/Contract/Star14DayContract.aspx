<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/14DayContract.master" AutoEventWireup="true" CodeFile="Star14DayContract.aspx.cs" Inherits="App_Contract_Star14DayContract" %>
        ...
        <ContentTemplate>
            ...
            <ajaxToolkit:TabContainer ID="smtAjaxTabs" runat="server" ActiveTabIndex="0" Width="99%">
                ...
                <ajaxToolkit:TabPanel ID="pnlRequests" runat="server" HeaderText="14 Day Contract Data Input" Visible="true">
                    ...
                    <ContentTemplate>
                        <uc6:DailyDataInputForm ID="DailyDataInputForm1" runat="server" />
                    </ContentTemplate>
