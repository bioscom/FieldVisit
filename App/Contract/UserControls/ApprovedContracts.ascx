<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ApprovedContracts.ascx.cs" Inherits="App_Contract_UserControls_ApprovedContracts" %>

<table class="tMainBorder" style="width: 98%">
    <tr>
        <td colspan="3" class="cHeadTile">Approved 14 Day Contracts</td>
    </tr>
    <tr>
        <td>
