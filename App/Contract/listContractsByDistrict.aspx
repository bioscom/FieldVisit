<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/14DayContract.master" AutoEventWireup="true" CodeFile="listContractsByDistrict.aspx.cs" Inherits="App_Contract_listContractsByDistrict" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    <table class="tMainBorder" style="width: 80%">
        <tr>
            <td class="cHeadTile">&nbsp;14 Day Contracts</td>
        </tr>
        <tr>
            <td>
