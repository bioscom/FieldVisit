<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="App_FLBM_Default2" %>
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left" valign="top" bgcolor="#ffffff" style="background-color:#ffffff;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="70px" align="center" valign="middle" style="padding:10px;">
                                        <img src="../../Images/ShellLogo.png" style="display:block;">
                                    </td>
                                    <td align="center" valign="middle" style="padding:10px; font-size:28px; font-family:Georgia, 'Times New Roman', Times, serif;">
                                        Bonga
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; padding:10px;">
                                        <div style="font-size:16px;">
                                            Dear {0},
                                        </div>
                                        <div style="font-size:12px;">
                                            You have Commitment Control for your review. It is raised by {1}.
                                            <br />
                                            <br />
                                            <b>Activity Description:</b> {2}</div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left" valign="middle" style="padding:15px; font-family:Arial, Helvetica, sans-serif;">
                                        <div style="font-size:12px; color:#525252;">
                                            ...
                                            <b>Activity Code :</b> {6}
                                            <br />
                                            <b>Cost Object:</b> {7}<br />
                                            <b>Activity Name:</b> {8}</div>
                                    </td>
                                </tr>
                                 <tr>
                                    <td align="left" valign="middle" style="padding:15px; font-family:Arial, Helvetica, sans-serif;">
                                        <div style="font-size:12px; color:#525252;">
                                            <b>Focal Point:</b> {9}<br />
                                            <b>Line Manager:</b> {10}<br />
                                            <b>Activity Owner :</b> {11}
                                            <br />
                                            <b>Acountable Manager :</b> {12}
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left" valign="middle" style="padding:15px; background-color:#564319; font-family:Arial, Helvetica, sans-serif;">
                                        <div style="font-size:20px; color:#fff;">
                                            <b>For support and assistance,</b>
                                        </div>
                                        <div style="font-size:13px; color:#ffe77b;">
                                            Contact the Administrators for support on ext 24772<br>
                                            <br>
                                            <a href="{14}" style="color:#ffe77b; text-decoration:underline;">CLICK HERE</a> TO LOG IN TO BONGA COMMITMENT CONTROL</div>
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="50%" align="left" valign="middle" style="color:#564319; font-size:11px; font-family:Arial, Helvetica, sans-serif; padding:10px;">
                                        <b>Hours:</b> Mon-Fri 7:00-4:00<br>
                                        <b>Support:</b> Isaac.Bejide<a href="mailto:Isaac.Bejide@Shell.com" style="color:#564319; text-decoration:none;">@Shell.com</a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
