<%@ Control Language="C#" AutoEventWireup="true" CodeFile="KnowledgeControl.ascx.cs" Inherits="App_FLBM_UserControl_KnowledgeControl" %>
            ...
            <tr>
                <td colspan="2">
                    <table style="width: 500px">
                        <tr>
                            <td>
                                <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Description of Competence:"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False" OnRowCommand="grdView_RowCommand" Width="100%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Level">
                        <ItemTemplate>
                            <asp:Label ID="lblLevel" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SLEVEL") %>'
                                ASSESSMENTID='<%# DataBinder.Eval(Container.DataItem, "ASSESSMENTID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Assessment/Assessor Comments">
                        <ItemTemplate>
                            <asp:TextBox ID="txtComment" Height="100px" Width="300px" TextMode="MultiLine" runat="server" Text=''></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <tr>
                <td>
                    <div style="float: right">
                        ...
                        &nbsp;<asp:Button ID="btnClose" runat="server" OnClick="btnClose_Click" Text="Close" Width="150px" ValidationGroup="close" />
                    </div>
                </td>
            </tr>
        </table>
