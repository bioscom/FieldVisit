<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/siteMasterFieldVisit.master" AutoEventWireup="true" CodeFile="Approved.aspx.cs" Inherits="Forms_SEPCiN_Approval_Approved" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="tSubGray" style="width: 100%">
                <tr>
                    <td class="cHeadTile">Approved PEC Request History</td>
                </tr>
                <tr>
                    <td>
                                ...
                                <asp:TemplateField HeaderText="Status">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="statusLinkButton" runat="server" CommandArgument="<%# Container.DisplayIndex %>"
                                            ...
                                            ID_APPROVAL='<%# DataBinder.Eval(Container.DataItem, "ID_APPROVAL") %>'
