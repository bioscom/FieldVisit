<%@ Control Language="C#" AutoEventWireup="true" CodeFile="approvedFieldVisitRequestsByApprover.ascx.cs"
    Inherits="UserControl_approvedFieldVisitRequestsByApprover" %>
        ...
        <%--<asp:TemplateField HeaderText="...">
            <ItemTemplate>
                <asp:LinkButton ID="editLinkButton" runat="server" 
                    ...
                    ID_ACTIVITIES='<%# DataBinder.Eval(Container.DataItem, "ID_ACTIVITIES") %>'>Edit</asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>--%>
