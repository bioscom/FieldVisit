...
public partial class UserControl_fieldVisitRequestsPendingMyApproval : aspnetUserControl
{
    ...
    public void RejectedRequests()
    {
        loadSiteVisitRequestsRejected();
        detailsPanel.Visible = false;
    }
    ...
    protected void grdView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (ButtonClicked == "viwFieldDetails")
        {
            ...
            long iActivity = int.Parse(lbFieldDetails.Attributes["ID_ACTIVITIES"].ToString());
    ...
    {
        System.Data.DataTable dt = fieldVisitDetails.dtPendingFieldVisitByApprover(oSessnx.getOnlineUser.m_iUserId, oSessnx.getOnlineUser.m_iRoleIdFieldVisit);
        ...
        else
        {
            foreach (GridViewRow grdRow in grdView.Rows)
            {
                ...
                long iActivityId = long.Parse(Action.Attributes["ID_ACTIVITIES"].ToString());
    ...
    private void loadSiteVisitRequestsRejected()
    {
        System.Data.DataTable dt = fieldVisitDetails.dtRejectedFieldVisiRequestsByApprover(oSessnx.getOnlineUser.m_iUserId, oSessnx.getOnlineUser.m_iRoleIdFieldVisit);
    ...
    private void loadFieldVisitDetailsByActivity(long iActivity)
    {
        ...
        fieldVisitInformation1.InitPage(iActivity);
