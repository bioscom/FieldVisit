<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AllPECRequestsPendingApproval.ascx.cs" Inherits="UserControl_SEPCiN_AllPECRequestsPendingApproval" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table class="tSubGray" style="width: 100%">
            <tr>
                <td class="cHeadTile">PEC Requests Pending Approval
                </td>
            </tr>
            <tr>
                <td>
                    <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="100" OnPageIndexChanging="grdView_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <%--<asp:TemplateField HeaderText="...">
                                <ItemTemplate>
                                    <asp:LinkButton ID="actionLinkButton" runat="server" CommandArgument="<%# Container.DisplayIndex %>"
                                        CommandName="Action" ID_ACTIVITYINFO='<%# DataBinder.Eval(Container.DataItem, "ID_ACTIVITYINFO") %>'
                            ...
                            <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                                    <asp:LinkButton ID="statusLinkButton" runat="server" CommandArgument="<%# Container.DisplayIndex %>"
                                        CommandName="viwStatus" Font-Bold="True" ID_ACTIVITYINFO='<%# DataBinder.Eval(Container.DataItem, "ID_ACTIVITYINFO") %>'
