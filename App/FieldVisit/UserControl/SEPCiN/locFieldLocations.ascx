<%@ Control Language="C#" AutoEventWireup="true" CodeFile="locFieldLocations.ascx.cs"
    Inherits="UserControl_fieldLocations" %>
<%@ Reference VirtualPath="~/App/FieldVisit/UserControl/SEPCiN/activityHeader.ascx" %>
<%@ Reference VirtualPath="~/App/FieldVisit/UserControl/SEPCiN/statusSelectorControl.ascx" %>
