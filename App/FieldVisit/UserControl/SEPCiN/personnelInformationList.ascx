...
<asp:LinkButton ID="addLinkButton" ValidationGroup="oooo" runat="server" OnClick="addLinkButton_Click">Add New Personnel</asp:LinkButton>
<br /><br />
    ...
    <div style="overflow: auto">
        <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False" ShowFooter="true"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Who is your contact person(s) in the field/FPSO?">
                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="When was your last visit to the field/FPSO?">
                    <EditItemTemplate>
