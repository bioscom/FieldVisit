...
public partial class UserControl_personnelInformationList : aspnetUserControl
{
    ...
    public void Retrieve_Data(long iActivityId)
    {
        ...
        grdView.DataSource = PersonnelInfo.dtGetPersonnelInfoByActivityId(iActivityId);
        grdView.DataBind();
    ...
    protected void addButton_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            bool bRet = PersonnelInfo.createPersonnelInfo(lActivityId, txtEmployeeName.Text, int.Parse(drpGender.SelectedValue),
    ...
    public void Retrieve_Data_EditGrid(long lActivityId)
    {
        ...
        grdView.DataSource = PersonnelInfo.dtGetPersonnelInfoByActivityId(lActivityId);
        grdView.DataBind();
    }
    ...
    protected void grdView_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            ePersonnelInfo.m_iID_ACTIVITYINFO = lActivityId;
