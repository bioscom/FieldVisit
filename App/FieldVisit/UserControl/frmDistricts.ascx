<%@ Control Language="C#" AutoEventWireup="true" CodeFile="frmDistricts.ascx.cs" Inherits="App_FieldVisit_UserControl_frmDistricts" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="~/App/FieldVisit/UserControl/frmFacilities.ascx" TagPrefix="app" TagName="frmFacilities" %>
...
<div style="width: 100%" class="demo-container size-narrow">
    <telerik:RadGrid ID="grdView" runat="server" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" AllowPaging="True" AllowSorting="true"
        ...
        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="ID_DISTRICT" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">

            <NestedViewTemplate>
                <div style="border-bottom: 2em">
                    <asp:Panel runat="server" ID="InnerContainer" CssClass="viewWrap" Visible="true">
                        <app:frmFacilities runat="server" ID="frmFacilities" />
                    </asp:Panel>
                </div>
            </NestedViewTemplate>
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="DISTRICT" HeaderButtonType="TextButton" HeaderText="Districts" SortExpression="DISTRICT"></telerik:GridBoundColumn>                
