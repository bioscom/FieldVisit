    ...
    <tr>
        <td>--%>
            <table style="width: 99%" class="tMainBorder">
                <tr>
                    <td class="cHeadTile" colspan="2">Flare Waiver Request Details</td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="Red" Text="Initiator:"></asp:Label>
                    </td>
                    <td>
                        <asp:Label ID="lblInitiator" ForeColor="Red" runat="server"></asp:Label>
                    </td>
                </tr>
            </table>
            <table style="width: 99%" class="tMainBorder">
                ...
                <tbody>
                    <tr>
                        <td>
                            Total Gas Volume Flared YTD:</td>
                        <td>
