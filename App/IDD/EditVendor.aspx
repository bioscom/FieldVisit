<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditVendor.aspx.cs" Inherits="App_IDD_EditVendor" %>
    ...
    <form id="form1" runat="server">
        <script type="text/javascript">
            ...
            function checkIDAvailability() {
                $.ajax({
                    type: "POST",
                    url: "EditVendor.aspx/checkVendorCode",
            ...
            function checkVendorNameAvailability() {
                $.ajax({
                    type: "POST",
                    url: "EditVendor.aspx/checkVendorName",
            ...
            <fieldset>
                ...
                <table style="width: 690px">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Submit" ValidationGroup="Renewal" Width="120px" />
                        </td>
                    </tr>
                </table>
            </fieldset>
