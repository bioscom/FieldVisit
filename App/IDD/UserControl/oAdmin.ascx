<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oAdmin.ascx.cs" Inherits="App_IDD_UserControl_oAdmin" %>
...
<div style="width:99%" class="demo-container size-narrow">
    <table style="color: black">
        <tr>
            <td>
                <asp:Label ID="lblLocation2" runat="server" Text="Search Admin:"></asp:Label>
            </td>
            <td>
            ...
            <td>
                <asp:Button ID="btnSave" runat="server" Text="Add Administrator" OnClick="btnSave_Click" Width="150px" />
            </td>
        </tr>
    </table>
...
<telerik:RadGrid ID="grdView" runat="server" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" AllowPaging="True" AllowSorting="true"
    ...
    <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="USERID" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
        <Columns>
            ...
            <telerik:GridBoundColumn DataField="FULLNAME" HeaderButtonType="TextButton" HeaderText="Administrators" SortExpression="FULLNAME"></telerik:GridBoundColumn>
