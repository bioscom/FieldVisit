...
public partial class App_IDD_UserControl_oAdmin : System.Web.UI.UserControl
{
    EIdd.Admins o = new EIdd.Admins();
    ...
    {
        grdView.DataSource = o.GetAdmins();
    }
    ...
    protected void grdView_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            (sender as RadGrid).DataSource = o.GetAdmins();
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        bool bRet = o.AddAdministrator(int.Parse(ddlAdmin.SelectedValue));
        LoadDataForgrdView();
        if (bRet) { ajaxWebExtension.showJscriptAlertCx(Page, this, "Successfully added as an Administrator!!!"); }
    }
