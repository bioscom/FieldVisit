...
public partial class App_IDD_UserControl_oCorporate : System.Web.UI.UserControl
{
    EIdd.Corporate o = new EIdd.Corporate();
    ...
    {
        grdView.DataSource = o.GetCorporates();
    }
    ...
    protected void grdView_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            (sender as RadGrid).DataSource = o.GetCorporates();
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        bool bRet = o.AddCorporateUser(int.Parse(ddlAdmin.SelectedValue));
        LoadDataForgrdView();
        if (bRet) { ajaxWebExtension.showJscriptAlertCx(Page, this, "Successfully added as a Corporate user to view IDD Database!!!"); }
    }
