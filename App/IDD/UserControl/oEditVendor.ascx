<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oEditVendor.ascx.cs" Inherits="App_IDD_UserControl_oEditVendor" %>
...
<script type="text/javascript">
    ...
    function checkIDAvailability() {
        $.ajax({
            type: "POST",
            url: "oEditRequest.ascx/checkVendorCode",
            ...
            function checkVendorNameAvailability() {
                $.ajax({
                    type: "POST",
                    url: "oEditRequest.ascx/checkVendorName",
                ...
                <tr>
                    <td colspan="2">
                        <div style="float: right">
                            <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Renew Request" Width="140px" />
                        </div>
