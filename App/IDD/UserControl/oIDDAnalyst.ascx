<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oIDDAnalyst.ascx.cs" Inherits="App_IDD_UserControl_oIDDAnalyst" %>
...
<div style="width: 99%" class="demo-container size-narrow">
    <table style="color: black">
        <tr>
            <td>
                <asp:Label ID="lblLocation2" runat="server" Text="Search Analyst:"></asp:Label>
            </td>
            <td>
                ...
                <telerik:RadComboBox RenderMode="Lightweight" ID="ddlAdmin" runat="server" Height="200" Width="430px" Font-Size="10pt"
                    DropDownWidth="500" EmptyMessage="Search for Analyst..." HighlightTemplatedItems="true"
            ...
            <td>
                <asp:Button ID="btnSave" runat="server" Text="Add Analyst" OnClick="btnSave_Click" Width="150px" />
            </td>
        </tr>
    </table>
    ...
    <telerik:RadGrid ID="grdView" runat="server" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" AllowPaging="True" AllowSorting="true"
        ...
        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="USERID" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="FULLNAME" HeaderButtonType="TextButton" HeaderText="IDD Analysts" SortExpression="FULLNAME"></telerik:GridBoundColumn>
