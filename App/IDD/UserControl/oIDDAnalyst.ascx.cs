...
public partial class App_IDD_UserControl_oIDDAnalyst : System.Web.UI.UserControl
{
    EIdd.Analysts o = new EIdd.Analysts();
    ...
    {
        grdView.DataSource = o.GetAnalysts();
    }
    ...
    protected void grdView_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            (sender as RadGrid).DataSource = o.GetAnalysts();
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        bool bRet = o.AddAnalyst(int.Parse(ddlAdmin.SelectedValue));
        LoadDataForgrdView();
        if (bRet) { ajaxWebExtension.showJscriptAlertCx(Page, this, "Successfully added as IDD Analyst!!!"); }
        grdView.Rebind();
    }
