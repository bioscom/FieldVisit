<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oIDDLeadFocalPoint.ascx.cs" Inherits="App_IDD_UserControl_oIDDLeadFocalPoint" %>
...
<div style="width: 99%" class="demo-container size-narrow">
    <table style="color: black">
        <tr>
            <td>
                <asp:Label ID="lblLocation2" runat="server" Text="Search CP IDD Focal Point:"></asp:Label>
            </td>
            <td>
                ...
                <telerik:RadComboBox RenderMode="Lightweight" ID="ddlAdmin" runat="server" Height="200" Width="430px" Font-Size="10pt"
                    DropDownWidth="500" EmptyMessage="Search For CP IDD Focal Point..." HighlightTemplatedItems="true"
            ...
            <td>
                <asp:Button ID="btnSave" runat="server" Text="Add CP IDD Focal Point" OnClick="btnSave_Click" Width="250px" />
            </td>
        </tr>
    </table>
    ...
    <telerik:RadGrid ID="grdView" runat="server" AllowAutomaticDeletes="true" AllowAutomaticInserts="true" AllowAutomaticUpdates="true" AllowPaging="True" AllowSorting="true"
        ...
        <MasterTableView AutoGenerateColumns="false" CommandItemDisplay="None" DataKeyNames="USERID" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="FULLNAME" HeaderButtonType="TextButton" HeaderText="CP IDD Focal Point" SortExpression="FULLNAME"></telerik:GridBoundColumn>
