<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oInVSR.ascx.cs" Inherits="App_IDD_UserControl_oInVSR" %>
...
<div id="demo" class="demo-container no-bg" style="width: 100%">
    ...
    <telerik:RadGrid RenderMode="Lightweight" ID="grdViewVsr" AllowSorting="true" runat="server" PageSize="15" AllowAutomaticInserts="true"
