...
public partial class App_IDD_UserControl_oInVSR : aspnetUserControl
{
    ...
    {
        grdViewVsr.DataSource = o.GetRequestsAssignedToMeAnalystInVSR(oSessnx.getOnlineUser.m_iUserId);
    }
    ...
    protected void grdView_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            (sender as RadGrid).DataSource = o.GetRequestsAssignedToMeAnalystInVSR(oSessnx.getOnlineUser.m_iUserId);
        }
    }
    ...
    protected void DocumentsGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            GridDataItem item = grdViewVsr.MasterTableView.Items[index];
    ...
    protected void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
    {
        ...
        {
            grdViewVsr.MasterTableView.SortExpressions.Clear();
            grdViewVsr.MasterTableView.GroupByExpressions.Clear();
            grdViewVsr.Rebind();
        }
        else if (e.Argument == "RebindAndNavigate")
        {
            grdViewVsr.MasterTableView.SortExpressions.Clear();
            grdViewVsr.MasterTableView.GroupByExpressions.Clear();
            grdViewVsr.MasterTableView.CurrentPageIndex = grdViewVsr.MasterTableView.PageCount - 1;
            grdViewVsr.Rebind();
        }
    }
    ...
    protected void ImageButton_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            grdViewVsr.MasterTableView.GetColumn("EmployeeID").HeaderStyle.BackColor = Color.LightGray;
            grdViewVsr.MasterTableView.GetColumn("EmployeeID").ItemStyle.BackColor = Color.LightGray;
        }
        #endregion
        grdViewVsr.ExportSettings.Excel.Format = (GridExcelExportFormat) Enum.Parse(typeof(GridExcelExportFormat), alternateText);
        //grdView.ExportSettings.IgnorePaging = CheckBox1.Checked;
        grdViewVsr.ExportSettings.ExportOnlyData = true;
        grdViewVsr.ExportSettings.OpenInNewWindow = true;
        grdViewVsr.MasterTableView.ExportToExcel();
    }
}