...
public partial class App_IDD_UserControl_oMyCompletedRequests : aspnetUserControl
{
    ...
    protected void grdView_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            (sender as RadGrid).DataSource = o.GetMyCompletedRequests(oSessnx.getOnlineUser.m_iUserId);
        }
    }
