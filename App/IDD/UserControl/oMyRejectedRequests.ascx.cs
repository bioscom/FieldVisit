...
public partial class App_IDD_UserControl_oMyRejectedRequests : aspnetUserControl
{
    ...
    {
        grdView.DataSource = o.GetMyRequestsRejected(oSessnx.getOnlineUser.m_iUserId);
    }
    ...
    protected void grdView_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            (sender as RadGrid).DataSource = o.GetMyRequestsRejected(oSessnx.getOnlineUser.m_iUserId);
        }
    }
