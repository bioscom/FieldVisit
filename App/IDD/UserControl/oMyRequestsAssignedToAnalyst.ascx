<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oMyRequestsAssignedToAnalyst.ascx.cs" Inherits="App_IDD_UserControl_oMyRequestsAssignedToAnalyst" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function ShowEditFormAssigned(id, rowIndex) {
        ...
        function ShowInsertFormAssigned() {
    ...
    <telerik:RadGrid RenderMode="Lightweight" ID="grdView" AllowSorting="true" runat="server" PageSize="15" AllowAutomaticInserts="true"
        ...
        <MasterTableView Width="100%" CommandItemDisplay="None" DataKeyNames="REQUESTID, VENDORID" AutoGenerateColumns="false" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn SortExpression="STAGE" HeaderText="Status" UniqueName="Remarks" HeaderButtonType="TextButton" DataField="STAGE"></telerik:GridBoundColumn>
            ...
            <CommandItemTemplate>
                <a href="#" onclick="return ShowInsertFormAssigned();">Add New Request</a>
            </CommandItemTemplate>
