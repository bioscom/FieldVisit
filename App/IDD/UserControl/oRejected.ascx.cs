...
public partial class App_IDD_UserControl_oRejected : aspnetUserControl
{
    ...
    {
        grdView.DataSource = o.GetRequestsRejected();
    }
    ...
    protected void grdView_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            (sender as RadGrid).DataSource = o.GetRequestsRejected();
        }
    }
