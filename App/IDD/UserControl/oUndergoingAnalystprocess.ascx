<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oUndergoingAnalystprocess.ascx.cs" Inherits="App_IDD_UserControl_oUndergoingAnalystprocess" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function ShowActionForm(id, rowIndex) {
            ...
            var wndw = window.radopen("AnalystAction.aspx?lRequestId=" + id, "ActionDialog", 700, 350);
            wndw.SetTitle("IDD Analyst Support");
    ...
    <telerik:RadGrid RenderMode="Lightweight" ID="grdView" AllowSorting="true" runat="server" PageSize="15" AllowAutomaticInserts="true"
        ...
        <MasterTableView Width="100%" DataKeyNames="REQUESTID, VENDORID" AutoGenerateColumns="false" InsertItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn SortExpression="DATE_ASSIGNED" HeaderText="Date Assigned" HeaderButtonType="TextButton" DataField="DATE_ASSIGNED" DataFormatString="{0:dd/MM/yyyy}"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn SortExpression="DATESCREENED" HeaderText="Effective Date" ItemStyle-Font-Bold="true" ItemStyle-ForeColor="Green" HeaderButtonType="TextButton" DataField="DATESCREENED" DataFormatString="{0:dd-MM-yyyy}"></telerik:GridBoundColumn>
                <telerik:GridBoundColumn SortExpression="VALIDTILL" HeaderText="Valid Till" ItemStyle-Font-Bold="true" ItemStyle-ForeColor="Green" HeaderButtonType="TextButton" DataField="VALIDTILL" DataFormatString="{0:dd-MM-yyyy}"></telerik:GridBoundColumn>
