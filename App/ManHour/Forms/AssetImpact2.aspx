<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/siteMasterManHour.master" AutoEventWireup="true" CodeFile="AssetImpact2.aspx.cs" Inherits="Forms_AssetImpact2" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="tSubGray" style="width: 98%">
        <tr>
            <td class="cHeadTile">View(2) Impact on Assets</td>
        </tr>
        <tr>
            <td valign="top">
                <div>
