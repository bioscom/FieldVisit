<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/siteMasterManHour.master" AutoEventWireup="true" CodeFile="ViewUser.aspx.cs" Inherits="Setup_ViewUser" %>
                ...
                <tr style="background-color: White">
                    <td colspan="2">
                        <div style="float: left">
                            <asp:LinkButton ID="lbAddNew" runat="server" PostBackUrl="~/App/FieldVisit/Forms/AddUser.aspx">Add New User</asp:LinkButton>
                        </div>
                        <div style="float: right">
                            <asp:LinkButton ID="lbAddC4CUsers" runat="server" PostBackUrl="~/Forms/AddC4CUsers.aspx">Add C4C User</asp:LinkButton>
                        </div>
                    ...
                    <td colspan="2">
                        <div style="background-color: White">
                            <asp:GridView ID="grdView" runat="server" AllowPaging="True" 
                                ...
                                OnSorted="grdView_Sorted" OnSorting="grdView_Sorting" PageSize="50" 
                                Width="100%">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
