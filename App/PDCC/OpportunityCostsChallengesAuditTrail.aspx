<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PDCC.master" AutoEventWireup="true" CodeFile="OpportunityCostsChallengesAuditTrail.aspx.cs" Inherits="App_PDCC_OpportunityCostsChallengesAuditTrail" %>

<%@ Register src="UserControl/AuditTrailCostChallenge.ascx" tagname="AuditTrailCostChallenge" tagprefix="uc2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
     <%--<table class="tMainBorder" style="width: 150%">
        <tr>
            <td class="cHeadTile">PD Cost Challenges Audit Trail</td>
        </tr>
        <tr>
            <td>
                <div>
                ...
                <asp:GridView ID="grdGridView" runat="server" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Date Updated">
                            <ItemTemplate>
                                <asp:Label ID="lblUpdated" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DATEUPDATED") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
