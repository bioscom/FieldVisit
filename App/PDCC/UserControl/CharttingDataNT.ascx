<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CharttingDataNT.ascx.cs" Inherits="App_PDCC_UserControl_CharttingDataNT" %>
...
<div style="background-color: white">          
    <asp:GridView ID="grdView" runat="server" AllowPaging="True"
        ...
        OnSelectedIndexChanged="grdView_SelectedIndexChanged" ShowFooter="true" FooterStyle-BackColor="White">
        <Columns>
