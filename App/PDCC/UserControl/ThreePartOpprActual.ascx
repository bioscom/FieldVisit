<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ThreePartOpprActual.ascx.cs" Inherits="App_PDCC_UserControl_ThreePartOpprActual" %>
...
<asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False"
    ...
    <Columns>
        <asp:TemplateField>
            <HeaderTemplate>
                <th colspan="38">Actual Savings</th>
                <tr class="gvHeader">
            ...
            <FooterTemplate>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="3 Parts Opportunity - Actual" Font-Bold="true"></asp:Label></td>
                <td></td>
                <td colspan="3">
