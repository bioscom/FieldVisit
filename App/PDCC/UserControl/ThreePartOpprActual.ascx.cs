...
public partial class App_PDCC_UserControl_ThreePartOpprActual : aspnetUserControl
{
    ...
    public void Init_ControlActualSavings(int iYear)
    {
        ...
        try
        {
            ...
            Label lbJan = (Label)grdView.FooterRow.FindControl("lbJan"); lbJan.Text = stringRoutine.formatAsBankMoney(oJanAct.dDD + oJanAct.dDDO + oJanAct.dEIO);
            Label lbFeb = (Label)grdView.FooterRow.FindControl("lbFeb"); lbFeb.Text = stringRoutine.formatAsBankMoney(oFebAct.dDD + oFebAct.dDDO + oFebAct.dEIO);
            Label lbMar = (Label)grdView.FooterRow.FindControl("lbMar"); lbMar.Text = stringRoutine.formatAsBankMoney(oMarAct.dDD + oMarAct.dDDO + oMarAct.dEIO);
            Label lbApr = (Label)grdView.FooterRow.FindControl("lbApr"); lbApr.Text = stringRoutine.formatAsBankMoney(oAprAct.dDD + oAprAct.dDDO + oAprAct.dEIO);
            Label lbMay = (Label)grdView.FooterRow.FindControl("lbMay"); lbMay.Text = stringRoutine.formatAsBankMoney(oMayAct.dDD + oMayAct.dDDO + oMayAct.dEIO);
            Label lbJun = (Label)grdView.FooterRow.FindControl("lbJun"); lbJun.Text = stringRoutine.formatAsBankMoney(oJunAct.dDD + oJunAct.dDDO + oJunAct.dEIO);
            Label lbJul = (Label)grdView.FooterRow.FindControl("lbJul"); lbJul.Text = stringRoutine.formatAsBankMoney(oJulAct.dDD + oJulAct.dDDO + oJulAct.dEIO);
            Label lbAug = (Label)grdView.FooterRow.FindControl("lbAug"); lbAug.Text = stringRoutine.formatAsBankMoney(oAugAct.dDD + oAugAct.dDDO + oAugAct.dEIO);
            Label lbSep = (Label)grdView.FooterRow.FindControl("lbSep"); lbSep.Text = stringRoutine.formatAsBankMoney(oSepAct.dDD + oSepAct.dDDO + oSepAct.dEIO);
            Label lbOct = (Label)grdView.FooterRow.FindControl("lbOct"); lbOct.Text = stringRoutine.formatAsBankMoney(oOctAct.dDD + oOctAct.dDDO + oOctAct.dEIO);
            Label lbNov = (Label)grdView.FooterRow.FindControl("lbNov"); lbNov.Text = stringRoutine.formatAsBankMoney(oNovAct.dDD + oNovAct.dDDO + oNovAct.dEIO);
            Label lbDec = (Label)grdView.FooterRow.FindControl("lbDec"); lbDec.Text = stringRoutine.formatAsBankMoney(oDecAct.dDD + oDecAct.dDDO + oDecAct.dEIO);
        }
        catch (Exception ex)
        {
    ...
    protected void grdView_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Init_ControlActualSavings(oTrans.tYear().iYear);
        //Init_Control(lInitiativeId);
    ...
    protected void grdView_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.jan, iYear, dJanDD, dJanDDO, dJanEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.feb, iYear, dFebDD, dFebDDO, dFebEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.mar, iYear, dMarDD, dMarDDO, dMarEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.apr, iYear, dAprDD, dAprDDO, dAprEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.may, iYear, dMayDD, dMayDDO, dMayEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.jun, iYear, dJunDD, dJunDDO, dJunEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.jul, iYear, dJulDD, dJulDDO, dJulEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.aug, iYear, dAugDD, dAugDDO, dAugEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.sep, iYear, dSepDD, dSepDDO, dSepEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.oct, iYear, dOctDD, dOctDDO, dOctEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.nov, iYear, dNovDD, dNovDDO, dNovEIO);
        ...
        ActualSavings(iAssetId, (int)mMonthEnuem.mMonth.dec, iYear, dDecDD, dDecDDO, dDecEIO);
    ...
    private void ActualSavings(int iAsset, int iMonth, int iYear, decimal DD, decimal DDO, decimal EIO)
    {
        bool bRet = false;
        PDActualSavings oPDActualSavings = new PDActualSavings();

        oPDActualSavings.iAssetId = iAsset;
        oPDActualSavings.iMonth = iMonth;
        oPDActualSavings.iYear = iYear;
        oPDActualSavings.iUserId = oSessnx.getOnlineUser.m_iUserId;

        oPDActualSavings.dDD = DD;
        oPDActualSavings.dDDO = DDO;
        oPDActualSavings.dEIO = EIO;

        var o = oPDCostReductionSummaryHelper.ObjGetAssetActualSavingByMonthYear(iAsset, iMonth, iYear);
        if (o.iAssetId == 0)
        {
        ...
        {
            bRet = oPDCostReductionSummaryHelper.UpdateActualSavings2(oPDActualSavings);
            //if (bRet)
            //{
