...
public partial class App_PDCC_UserControl_ThreePartOpprSavings : aspnetUserControl
{
    ...
    public void Init_ControlEstimatedSavings(int iYear)
    {
        ...
        try
        {
            foreach (GridViewRow grdRow in grdView.Rows)
            {
                ...
                PDEstimatedSavings oJan = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.jan, iYear);
                PDEstimatedSavings oFeb = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.feb, iYear);
                PDEstimatedSavings oMar = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.mar, iYear);
                PDEstimatedSavings oApr = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.apr, iYear);
                PDEstimatedSavings oMay = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.may, iYear);
                PDEstimatedSavings oJun = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.jun, iYear);
                PDEstimatedSavings oJul = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.jul, iYear);
                PDEstimatedSavings oAug = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.aug, iYear);
                PDEstimatedSavings oSep = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.sep, iYear);
                PDEstimatedSavings oOct = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.oct, iYear);
                PDEstimatedSavings oNov = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.nov, iYear);
                PDEstimatedSavings oDec = o.ObjGetAssetEstimatedSavingByMonthYear(iAssetId, (int)mMonthEnuem.mMonth.dec, iYear);
            ...
            PDEstimatedActualSavings oJanEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.jan, iYear);
            PDEstimatedActualSavings oFebEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.feb, iYear);
            PDEstimatedActualSavings oMarEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.mar, iYear);
            PDEstimatedActualSavings oAprEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.apr, iYear);
            PDEstimatedActualSavings oMayEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.may, iYear);
            PDEstimatedActualSavings oJunEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.jun, iYear);
            PDEstimatedActualSavings oJulEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.jul, iYear);
            PDEstimatedActualSavings oAugEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.aug, iYear);
            PDEstimatedActualSavings oSepEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.sep, iYear);
            PDEstimatedActualSavings oOctEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.oct, iYear);
            PDEstimatedActualSavings oNovEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.nov, iYear);
            PDEstimatedActualSavings oDecEst = o.ObjGetEstimatedSavingByMonthYear((int)mMonthEnuem.mMonth.dec, iYear);
    ...
    {
        grdView.EditIndex = -1;
        Init_ControlEstimatedSavings(oTrans.tYear().iYear);
    }
    ...
    protected void grdView_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.jan, iYear, dJanDD, dJanDDO, dJanEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.feb, iYear, dFebDD, dFebDDO, dFebEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.mar, iYear, dMarDD, dMarDDO, dMarEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.apr, iYear, dAprDD, dAprDDO, dAprEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.may, iYear, dMayDD, dMayDDO, dMayEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.jun, iYear, dJunDD, dJunDDO, dJunEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.jul, iYear, dJulDD, dJulDDO, dJulEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.aug, iYear, dAugDD, dAugDDO, dAugEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.sep, iYear, dSepDD, dSepDDO, dSepEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.oct, iYear, dOctDD, dOctDDO, dOctEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.nov, iYear, dNovDD, dNovDDO, dNovEIO);
        ...
        EstimatedSavings(iAssetId, (int)mMonthEnuem.mMonth.dec, iYear, dDecDD, dDecDDO, dDecEIO);
    ...
    private void EstimatedSavings(int iAsset, int iMonth, int iYear, decimal DD, decimal DDO, decimal EIO)
    {
        bool bRet = false;
        PDEstimatedSavings oPDEstimatedSavings = new PDEstimatedSavings();
        oPDEstimatedSavings.iAssetId = iAsset;
        oPDEstimatedSavings.iMonth = iMonth;
        oPDEstimatedSavings.iYear = iYear;
        oPDEstimatedSavings.iUserId = oSessnx.getOnlineUser.m_iUserId;

        oPDEstimatedSavings.dDD = DD;
        oPDEstimatedSavings.dDDO = DDO;
        oPDEstimatedSavings.dEIO = EIO;

        var ox = o.ObjGetAssetEstimatedSavingByMonthYear(iAsset, iMonth, iYear);
        if (ox.iAssetId == 0)
        {
            bRet = o.InsertEstimatedSavings(oPDEstimatedSavings);
            //if (bRet)
            //{
        ...
        {
            bRet = o.UpdateEstimatedSavings2(oPDEstimatedSavings);
            //if (bRet)
            //{
