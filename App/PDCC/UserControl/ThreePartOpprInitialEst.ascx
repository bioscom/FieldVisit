<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ThreePartOpprInitialEst.ascx.cs" Inherits="App_PDCC_UserControl_ThreePartOpprInitialEst" %>
...
<asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False"
    ...
    <Columns>
        <asp:TemplateField>
            <HeaderTemplate>
                <th colspan="38">Estimated Savings - 25% Reduction (Initial Estimate)</th>
                <tr class="gvHeader">
            ...
            <FooterTemplate>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="PD Estimated Savings - 25% Reduction" Font-Bold="true"></asp:Label></td>
                <td></td>
                <td colspan="3">
