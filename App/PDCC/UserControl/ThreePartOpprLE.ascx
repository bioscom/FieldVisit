<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ThreePartOpprLE.ascx.cs" Inherits="App_PDCC_UserControl_ThreePartOpprLE" %>
...
<asp:GridView ID="grdView" runat="server" AutoGenerateColumns="False"
    ...
    <Columns>
        <asp:TemplateField>
            <HeaderTemplate>
                <th colspan="38">Latest Estimates</th>
                <tr class="gvHeader">
            ...
            <FooterTemplate>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="PD Latest Estimate" Font-Bold="true"></asp:Label></td>
                <td></td>
                <td colspan="3">
