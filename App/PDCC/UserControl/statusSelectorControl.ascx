...
<asp:CompareValidator ID="statusValidation" runat="server" ControlToValidate="statusDrp" ErrorMessage="Please Select Status" Operator="NotEqual" Type="Integer" ValueToCompare="-1">*</asp:CompareValidator>
