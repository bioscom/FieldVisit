<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ActionTracker.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="App_PPMS_Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="Server">
    <table class="tMainBorder" style="Width:140%">
        ...
        <tr>
            <td>
                <asp:Button ID="btnRegister" runat="server" OnClick="btnRegister_Click" Text="Register New Project" Width="220px" />
            &nbsp;
                <asp:Button ID="btnExport" runat="server" OnClick="btnExport_Click" Text="Export Projects" Width="180px" />
            </td>
        </tr>
        <tr>
            <td>
