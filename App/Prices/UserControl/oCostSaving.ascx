<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oCostSaving.ascx.cs" Inherits="App_Prices_UserControl_oCostSaving" %>

<asp:LinkButton ID="lnkAddNew" runat="server">+ Add New Cost Red Flag</asp:LinkButton>
