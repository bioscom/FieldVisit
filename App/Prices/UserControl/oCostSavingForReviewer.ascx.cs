...
public partial class App_Prices_UserControl_oCostSavingForReviewer : aspnetUserControl
{
    long lPriceId = 0;
    ...
    private void LoadPendingSubmittedPrices()
    {
    ...
    private void LoadClosedOutPrices()
    {
