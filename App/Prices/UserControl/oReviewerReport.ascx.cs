...
public partial class App_Prices_UserControl_oReviewerReport : aspnetUserControl
{
    ...
    public void Page_Init(object sender, EventArgs e)
    {
        ...
        sRequestHF.Value = lPriceId.ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (bRet)
        {
            ...
            LoadRecord(long.Parse(sRequestHF.Value));
    ...
    private void LoadRecord(long lPriceId)
    {
        //long lPriceId = long.Parse(Request.QueryString["lPriceId"]);
