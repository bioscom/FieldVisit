...
public class loginUser
{
    ...
    public loginRet verifyAppUser()
    {
        ...
        eRet.eAppUserInfo = new appUsers();
        ...
        try
        {
            ...
            appUsers FoundOnAppUserMgt = appUsersHelper.objGetAppUser(Apps.LoginIDNoDomain(HttpContext.Current.Request.LogonUserIdentity.Name)); //Apps.LoginIDNoDomain(HttpContext.Current.User.Identity.Name)
            ...
            {
                //Confirm on Information Ware House
                eRet = CheckInformationWareHouse(eRet);
            }
        }
        catch (Exception ex)
        {
    ...
    private loginRet CheckInformationWareHouse(loginRet eRet)
    {
        //Check for the user on the Information Ware House
        CompleteStaffDetailsInfo FoundOnIWH = Users.getStaffFromCompleteStaffDetails(Apps.LoginIDNoDomain(HttpContext.Current.User.Identity.Name));
    ...
    private loginRet AuthenticationVerification(appUsers o)
    {
        loginRet eRet = new loginRet();
        string p_sUserId = o.m_sUserName;

        //A session is created for the Logged in user here...
        eRet.eAppUserInfo = o;
        ...
        switch (o.m_sStatus)
        {
            case (int)appUsersRoles.userStatus.activeUser:
                ...
                appUsersHelper.UpdateUserLastLogOn(o.m_iUserId);
