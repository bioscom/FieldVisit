...
public class PersonnelInfo
{
    ...
    public PersonnelInfo(DataRow dr)
    {
        ...
        m_iID_ACTIVITYINFO = long.Parse(dr["ID_ACTIVITYINFO"].ToString());
    ...
    public static DataTable dtGetPersonnelInfoByActivityId(long iActivityId)
    {
        OracleCommand comm = GenericDataAccess.CreateCommand();
        comm.CommandText = StoredProcedure.getPersonnelInformationByActivityId();
    ...
    public static PersonnelInfo objGetPersonnelInfoByActivityId(int iActivityId)
    {
        DataTable dt = dtGetPersonnelInfoByActivityId(iActivityId);
    ...
    public static List<PersonnelInfo> lstGetPersonnelInfoByActivityId(long iActivityId)
    {
        DataTable dt = dtGetPersonnelInfoByActivityId(iActivityId);
    ...
    public static bool createPersonnelInfo(long iID_ACTIVITYINFO, string sEMPLOYEE_NAME, int iGENDER,
       int iID_CONTACT, int iID_LAST_VISIT, int iBOSIET_VALID, int iHUET_VALID, int iMEDICAL,
        int iID_VISA, int iPPE, int iID_BAG, string sCOMPANY)
    {
        OracleCommand comm = GenericDataAccess.CreateCommand();
